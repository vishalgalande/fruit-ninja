...
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage , gameOverSound , chopSound;
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    monsterGroup.velocityXEach=-(8+(score/10));
    fruitGroup.velocityXEach=-(8+(score/10));
